...
/**
 * Operation Nr Parser Responsable
 * 
 * @author Bastian Kraus <bofh@k-hive.de>
 */
class OperationNrParserResponsable extends AlarmFaxParserPatternMatcherResponsable {

	@Override
	public Pattern getPattern() {
		return Pattern.compile(OpenflorianConfig.config().faxParser.patterns.operationNrPattern,
	...
	public void parse(String alarmfax, Operation operation) {
		...
		if (m.find()) {
			operation.setOperationNr(m.group(1).trim());
		}
